    ...
    <b-navbar toggleable="lg" dark sticky="top" style="background-color: #57739a">
        ...
        <b-collapse id="nav-collapse" is-nav>
            <b-navbar-nav class="me-auto">
                <b-nav-item to="/about" :disabled="!router.hasRoute('about')">About</b-nav-item>
                <b-nav-item to="/contact" :disabled="!router.hasRoute('contact')">Contact</b-nav-item>
                <b-nav-item to="/gallery" :disabled="!router.hasRoute('gallery')">Gallery</b-nav-item>
            </b-navbar-nav>
            <b-navbar-nav>
